...
const seedState = () => {
  ...
  const customers = [
    ...
    { id: 12, customer_name: "Valued Customer", company_name: "Sword Client", email: "customer@sword.com", phone: "+44-20-8000-0000", address_line_1: "100 Customer Way", address_line_2: "", country: "United Kingdom", state: "Greater London", city: "London", pincode: "SW1A 1AA", latitude: 51.5014, longitude: -0.1419, delivery_priority: "normal", status: "active" },
  ];
